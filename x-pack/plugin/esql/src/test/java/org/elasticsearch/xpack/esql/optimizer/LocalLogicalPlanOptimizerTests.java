...
public class LocalLogicalPlanOptimizerTests extends ESTestCase {
    ...
    public static void init() {
        ...
        var logicalOptimizerCtx = unboundLogicalOptimizerContext();
        ...
        var tsDownsampledIndex = EsIndexGenerator.esIndex("k8s-downsampled", tsDownsampledMapping, Map.of("k8s", IndexMode.TIME_SERIES));
...
//            """;
    ...
    public void testVectorFunctionsWhenFieldMissing() {
        assumeTrue("requires fusing from_aggregate_metric_double", EsqlCapabilities.Cap.SPATIAL_FUNCTIONS_FIX_CRSTYPE_FOLDING.isEnabled());
        SimilarityFunctionTestCase testCase = SimilarityFunctionTestCase.random("dense_vector");
        String query = String.format(Locale.ROOT, """
            from test_all
            | eval s = %s
